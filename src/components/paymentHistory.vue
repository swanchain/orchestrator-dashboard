        ...
        <el-table-column prop="status" label="status" min-width="110">
          <template #default="scope">
            <div>
              ...
              <span v-else-if="scope.row.status && scope.row.status.toLowerCase() === 'terminated'" class="flex-row center">
                Task Early Terminated &nbsp;
                <el-popover placement="top" :width="200" effect="dark" popper-style="word-break: break-word; text-align: left;font-size:12px;" trigger="hover" content="Reward send to cp’s wallet automatically">
                  <template #reference>
                    <div class="flex-row">
